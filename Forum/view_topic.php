<?php
	...
	//4d
	$sql2="SELECT * FROM $tbl_name JOIN members ON members.member_id = topic.member_id";
...
<tr>
<?php //4d ?>
<td bgcolor="#F8F7F1"><strong>By : <?php echo $rows['login'] ?></td>
</tr>
...
//4d
<td width="5%" bgcolor="#F8F7F1">: $rows['login'] </td>
